...
const ENEMIES = {
  ...
  golem_horno: {
    ...
    xp: 150, gold: 70,
    skills: [
      { id: 'puño_ardiente', name: 'Puño Ardiente', type: 'attack', power: 35, scaling: { fue: 1.0 } },
  ...
  devorador_sueños: {
    id: 'devorador_sueños', name: 'Devorador de Sueños', icon: '🌙',
    type: 'elite', level: 18,
...
function pickRandomEnemy(theme, playerLevel, encounterType = 'common') {
  ...
  // Filter by level (±5 of player level)
...
const THEME_ENEMIES = {
  ...
  mente: ['pesadilla', 'devorador_sueños'],
