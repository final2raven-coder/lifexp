...
function assertCanonicalState(state) {
  ...
  assert.ok(state.materialInteractions && state.materialInteractions.version === 1);
  assert.ok(state.materialInteractions.ledger && state.materialInteractions.discoveredUses);
