...
function isAppAsset(request) {
  ...
  return /\/(?:build-info\.js|build-info\.json|index\.html|item_flavor\.js|data_tasks\.js|engine\.js|material_interactions\.js|ui_hub\.js|ui_tasks\.js|ui_combat\.js|ui_misc\.js|guild\.js|ui_feedback\.js|ui_quests\.js|item_system\.js|main\.js|items\.js|classes\.js|enemies\.js|combat\.js|quests\.js|expansion_[^/]+\.js|update2_content\.js|inventory_system\.js)$/.test(pathname);
}
