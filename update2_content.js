...
(function () {
  ...
  const QUEST_PATCHES = {
    ...
    daily_cuerpo_2: { name: 'The Traveller\'s Readiness', desc: 'Strengthen the body before the road asks for its price.', setting: 'Beyond the last gate, the old road climbs without shelter or easy ground.', lore: 'The road does not care how strong you meant to become. It remembers only what you carried.' },
