...
## Fase B -- Unificar aliases (Pendiente aprobacion)

Objetivo: una sola fuente de verdad para aliases de items. Actualmente hay tres tablas distintas en inventory_system.js, ashbrand_hotfix.js y game.js (~L3772).
Ficheros que toca: inventory_system.js, ashbrand_hotfix.js, game.js.
Riesgo: bajo-medio. Se comparan las tres tablas linea a linea antes de escribir.
Como verificarlo: abre el inventario. Todos los items aparecen con nombre y rareza correctos. No hay slots "?".

---

## Fase C -- Eliminar fallback hardcodeado (Pendiente aprobacion)
...
## Fase D -- Fusionar ashbrand_hotfix en inventory_system (Pendiente aprobacion)
...
## Fase E -- Unificar funciones duplicadas de quests (Pendiente aprobacion)
...
## Fase F -- Mover ITEM_FLAVOR_TEXT fuera de game.js (Pendiente aprobacion)
...
## Fase G -- Split de game.js (Pendiente aprobacion)
