...
const EXPANSION_ITEMS_V1 = {
  ...
  cristal_tranquilidad:{id:'cristal_tranquilidad',name:'Stillstone',type:'accessory',rarity:'uncommon',icon:'GEM',desc:'A pale blue stone found only in caves where no wind has ever reached. It absorbs ambient noise and stays cold regardless of temperature.',stats:{vol:2,int:1},value:45,themes:['descanso','mente']},value:45,themes:['descanso','mente']},
  ...
  amuleto_explorador:{id:'amuleto_explorador',name:'Pathfinder's Compass Rose',type:'accessory',rarity:'uncommon',icon:'RING',desc:'A small medallion engraved with a compass rose that points toward the nearest unexplored territory rather than north.',stats:{des:2,vit:1},value:52,themes:['exploracion']},value:52,themes:['exploracion']},
  ...
  tridente_menor:{id:'tridente_menor',name:'Tidecaller's Prong',type:'weapon',rarity:'uncommon',icon:'TRIDENT',desc:'A short trident used by coastal militia to drive off sea creatures. The tines are still sharp. The wielder is not accounted for.',stats:{fue:2,des:2},value:65,themes:['agua_profunda']},value:65,themes:['agua_profunda']},
  ...
  ojo_comerciante:{id:'ojo_comerciante',name:'Assessor's Monocle',type:'accessory',rarity:'uncommon',icon:'GEM',desc:'A single-lens instrument used by guild assessors to detect counterfeit goods. It also makes prices easier to read in dim light.',stats:{int:2,pre:1},value:55,themes:['comercio','gestiones']},value:55,themes:['comercio','gestiones']},
  ...
  anillo_vinculo:{id:'anillo_vinculo',name:'Covenant Band',type:'accessory',rarity:'uncommon',icon:'RING',desc:'A plain ring exchanged as a promise between two people who chose each other deliberately. It fits both of them.',stats:{pre:2,vol:1},value:50,themes:['social','alianzas']},value:50,themes:['social','alianzas']},
